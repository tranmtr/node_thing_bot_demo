module.exports = function(RED) {
    function TemperatureDataNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            if (payload.temperature === undefined) {
                node.warn("Dữ liệu temperature không hợp lệ hoặc bị thiếu trong msg.payload. Payload hiện tại: " + JSON.stringify(payload));
                return;
            }
            ...
            dataEntry.dataType = "temperature";
            dataEntry.temperature = payload.temperature !== undefined ? payload.temperature.toFixed(2) : "N/A";
    ...
    RED.nodes.registerType("temperature-filter-ui-table", TemperatureDataNode);
};
